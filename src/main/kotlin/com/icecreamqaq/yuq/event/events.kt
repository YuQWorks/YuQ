...
open class GroupBanMemberEvent(val member: Member, val operator: Member, val time: Int) : Event()
open class GroupUnBanMemberEvent(val member: Member, val operator: Member) : Event()
open class GroupBanBotEvent(val member: Member, val operator: Member, val time: Int) : Event()
